...
public enum BannerPattern {
    ...
    private static final Map<String, BannerPattern> byString = new HashMap<>();

    static {
        for (BannerPattern p : values()) {
            byString.put(p.identifier, p);
        }
    }

    private BannerPattern(String key) {
        this.identifier = key;
    }
     ...
     */
    public static BannerPattern getByIdentifier(String identifier) {
