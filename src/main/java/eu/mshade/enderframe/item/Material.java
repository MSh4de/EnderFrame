...
public class Material {
    ...
    public static MaterialKey OAK_WOOD_PLANKS = MaterialKey.from(13, 64, NamespacedKey.minecraft("oak_wood_planks"), Set.of(MaterialCategory.BLOCK, MaterialCategory.WOOD));
    public static MaterialKey SPRUCE_WOOD_PLANKS = MaterialKey.from(14, 64, NamespacedKey.minecraft("spruce_wood_planks"), Set.of(MaterialCategory.BLOCK, MaterialCategory.WOOD));
    public static MaterialKey BIRCH_WOOD_PLANKS = MaterialKey.from(15, 64, NamespacedKey.minecraft("birch_wood_planks"), Set.of(MaterialCategory.BLOCK, MaterialCategory.WOOD));
    public static MaterialKey JUNGLE_WOOD_PLANKS = MaterialKey.from(16, 64, NamespacedKey.minecraft("jungle_wood_planks"), Set.of(MaterialCategory.BLOCK, MaterialCategory.WOOD));
    public static MaterialKey ACACIA_WOOD_PLANKS = MaterialKey.from(17, 64, NamespacedKey.minecraft("acacia_wood_planks"), Set.of(MaterialCategory.BLOCK, MaterialCategory.WOOD));
    public static MaterialKey DARK_OAK_WOOD_PLANKS = MaterialKey.from(18, 64, NamespacedKey.minecraft("dark_oak_wood_planks"), Set.of(MaterialCategory.BLOCK, MaterialCategory.WOOD));

    public static MaterialKey OAK_SAPLING = MaterialKey.from(19, 64, NamespacedKey.minecraft("oak_sapling"), Set.of(MaterialCategory.BLOCK, MaterialCategory.PLANT));
    public static MaterialKey SPRUCE_SAPLING = MaterialKey.from(20, 64, NamespacedKey.minecraft("spruce_sapling"), Set.of(MaterialCategory.BLOCK, MaterialCategory.PLANT));
    public static MaterialKey BIRCH_SAPLING = MaterialKey.from(21, 64, NamespacedKey.minecraft("birch_sapling"), Set.of(MaterialCategory.BLOCK, MaterialCategory.PLANT));
    public static MaterialKey JUNGLE_SAPLING = MaterialKey.from(22, 64, NamespacedKey.minecraft("jungle_sapling"), Set.of(MaterialCategory.BLOCK, MaterialCategory.PLANT));
    public static MaterialKey ACACIA_SAPLING = MaterialKey.from(23, 64, NamespacedKey.minecraft("acacia_sapling"), Set.of(MaterialCategory.BLOCK, MaterialCategory.PLANT));
    public static MaterialKey DARK_OAK_SAPLING = MaterialKey.from(24, 64, NamespacedKey.minecraft("dark_oak_sapling"), Set.of(MaterialCategory.BLOCK, MaterialCategory.PLANT));

    public static MaterialKey BEDROCK = MaterialKey.from(25, 64, NamespacedKey.minecraft("bedrock"), Set.of(MaterialCategory.BLOCK));
    public static MaterialKey WATER = MaterialKey.from(26, 64, NamespacedKey.minecraft("water"), Set.of(MaterialCategory.BLOCK));
    public static MaterialKey FLOWING_WATER = MaterialKey.from(27, 64, NamespacedKey.minecraft("flowing_water"), Set.of(MaterialCategory.BLOCK));
    public static MaterialKey LAVA = MaterialKey.from(28, 64, NamespacedKey.minecraft("lava"), Set.of(MaterialCategory.BLOCK));
    public static MaterialKey FLOWING_LAVA = MaterialKey.from(29, 64, NamespacedKey.minecraft("flowing_lava"), Set.of(MaterialCategory.BLOCK));

    public static MaterialKey SAND = MaterialKey.from(30, 64, NamespacedKey.minecraft("sand"), Set.of(MaterialCategory.BLOCK));
    public static MaterialKey RED_SAND = MaterialKey.from(31, 64, NamespacedKey.minecraft("red_sand"), Set.of(MaterialCategory.BLOCK));
    public static MaterialKey GRAVEL = MaterialKey.from(32, 64, NamespacedKey.minecraft("gravel"), Set.of(MaterialCategory.BLOCK));

    public static MaterialKey GOLD_ORE = MaterialKey.from(33, 64, NamespacedKey.minecraft("gold_ore"), Set.of(MaterialCategory.BLOCK, MaterialCategory.ORE));
    public static MaterialKey IRON_ORE = MaterialKey.from(34, 64, NamespacedKey.minecraft("iron_ore"), Set.of(MaterialCategory.BLOCK, MaterialCategory.ORE));
    public static MaterialKey COAL_ORE = MaterialKey.from(35, 64, NamespacedKey.minecraft("coal_ore"), Set.of(MaterialCategory.BLOCK, MaterialCategory.ORE));
    public static MaterialKey LAPIS_ORE = MaterialKey.from(36, 64, NamespacedKey.minecraft("lapis_ore"), Set.of(MaterialCategory.BLOCK, MaterialCategory.ORE));

    public static MaterialKey OAK_LOG = MaterialKey.from(37, 64, NamespacedKey.minecraft("oak_log"), Set.of(MaterialCategory.BLOCK, MaterialCategory.LOG));
    public static MaterialKey SPRUCE_LOG = MaterialKey.from(36, 64, NamespacedKey.minecraft("spruce_log"), Set.of(MaterialCategory.BLOCK, MaterialCategory.LOG));
    public static MaterialKey BIRCH_LOG = MaterialKey.from(37, 64, NamespacedKey.minecraft("birch_log"), Set.of(MaterialCategory.BLOCK, MaterialCategory.LOG));
    public static MaterialKey JUNGLE_LOG = MaterialKey.from(38, 64, NamespacedKey.minecraft("jungle_log"), Set.of(MaterialCategory.BLOCK, MaterialCategory.LOG));
    public static MaterialKey ACACIA_LOG = MaterialKey.from(39, 64, NamespacedKey.minecraft("acacia_log"), Set.of(MaterialCategory.BLOCK, MaterialCategory.LOG));
    public static MaterialKey DARK_OAK_LOG = MaterialKey.from(40, 64, NamespacedKey.minecraft("dark_oak_log"), Set.of(MaterialCategory.BLOCK, MaterialCategory.LOG));
