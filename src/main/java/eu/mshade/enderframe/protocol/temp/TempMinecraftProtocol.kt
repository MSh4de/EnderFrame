...
class TempMinecraftProtocol : MinecraftProtocol() {
    ...
    init {
        ...
        getProtocolRegistry().registerOut(MinecraftProtocolStatus.STATUS, 0x00, MinecraftPacketOutServerStatus::class.java)
        getProtocolRegistry().registerOut(MinecraftProtocolStatus.STATUS, 0x01, MinecraftPacketOutServerPong::class.java)
        getProtocolRegistry().registerIn(MinecraftProtocolStatus.STATUS, 0x00, MinecraftPacketInServerStatus::class.java)
        getProtocolRegistry().registerIn(MinecraftProtocolStatus.STATUS, 0x01, MinecraftPacketInServerPing::class.java)
